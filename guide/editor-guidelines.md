...
<div style="text-align: right"><i>Изменения от 08.08.2022:<br>
* Добавлена информация про "уставные" знаки препинания<br>
* Поправлены кавычки в существующих примерах<br>
* Изменено правило буквы "ё" - проставляем её</i>
</div>